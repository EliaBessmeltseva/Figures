...
square(-28, 313, 35, 'cyan', 90, 0)         # House (Nastya)
parallelogram(-64, 277, 35, 60, 'pink', 135, 45, -225)
triangle(39, 234, 45, 65, 'red', 135, 90, 0)
triangle(40, 169, 45, 65, 'yellow', 135, 90, 270)
triangle(-90, 170, 90, 128, 'blue', 135, 90, 180)
triangle(-70, 235, 90, 128, 'orange', 135, 90, 180)
triangle(-90, 170, 64, 70, 'green', 135, 90, 225)


square(-72, -158, 43, 'blue', 90, 45)         # Swan (Nastya)
parallelogram(-72, -157, 60, 43, 'purple', 135, 45, 225)
triangle(-73, -96, 45, 65, 'red', 135, 90, 45)
triangle(-104, -188, 45, 65, 'cyan', 135, 90, 90)
triangle(69, -210, 90, 128, 'orange', 135, 90, 0)
triangle(30, -299, 90, 128, 'green', 135, 90, -45)
triangle(-60, -299, 64, 70, 'yellow', 135, 90, 270)
